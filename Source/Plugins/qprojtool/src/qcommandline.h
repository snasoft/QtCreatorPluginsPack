...
public:
     ...
     */
    explicit QCommandLine(QObject * parent = 0);
     ...
     * @sa setConfig
     */
    explicit QCommandLine(const QCoreApplication & app,
     ...
     * @sa setConfig
     */
    explicit QCommandLine(int argc, char *argv[],
		 const QCommandLineConfig & config = QCommandLineConfig(),
		 QObject * parent = 0);
     ...
     * @sa setConfig
     */
    explicit QCommandLine(const QStringList args,
		 const QCommandLineConfig & config = QCommandLineConfig(),
		 QObject * parent = 0);
   ...
   ~QCommandLine();
    ...
    /**
     * Set a description to the application
     * @param descrition to show in help
     * @sa showHelp()
     */
    inline void setDescription(const QString& desc) { d->description = desc; }
    /**

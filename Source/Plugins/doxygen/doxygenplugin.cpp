...
bool DoxygenPlugin::initialize(const QStringList &arguments, QString *error_message)
{
    ...
    Core::ActionContainer *toolsContainer = Core::ActionManager::instance()->actionContainer(Core::Constants::M_TOOLS);
    Core::ActionContainer *doxygenMenu = Core::ActionManager::instance()->createMenu(Core::Id(CMD_ID_DOXYGEN_MENU));
    ...
    command = Core::ActionManager::instance()->registerAction(m_doxygenCreateDocumentationAction, CMD_ID_CREATEDOCUMENTATION, globalcontext);
    ...
    Core::ActionContainer *contextMenu= Core::ActionManager::instance()->createMenu(CppEditor::Constants::M_CONTEXT);
    contextMenu->addAction(command);
    // create documentation for a whole file
    m_doxygenDocumentFileAction = new QAction(tr("Document whole file"),  this);
    command = Core::ActionManager::instance()->registerAction(m_doxygenDocumentFileAction, CMD_ID_DOCUMENTFILE, globalcontext);
    command->setAttribute(Core::Command::CA_UpdateText);
    ...
    command = Core::ActionManager::instance()->registerAction(m_doxygenDocumentOpenedProjectAction,
    ...
    command = Core::ActionManager::instance()->registerAction(m_doxygenDocumentActiveProjectAction,
    ...
    command = Core::ActionManager::instance()->registerAction(m_doxygenBuildDocumentationAction, CMD_ID_BUILDDOCUMENTATION, globalcontext);
    command->setAttribute(Core::Command::CA_UpdateText);
    ...
    command = Core::ActionManager::instance()->registerAction(m_doxygenDoxyfileWizardAction, CMD_ID_DOXYFILEWIZARD, globalcontext);
    command->setAttribute(Core::Command::CA_UpdateText);

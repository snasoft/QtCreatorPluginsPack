...
#ifndef PROJECTLINECOUNTER_GLOBAL_H
#define PROJECTLINECOUNTER_GLOBAL_H

#include <QtGlobal>

#if defined(PROJECTLINECOUNTER_LIBRARY)
#  define PROJECTLINECOUNTERSHARED_EXPORT Q_DECL_EXPORT
#else
#  define PROJECTLINECOUNTERSHARED_EXPORT Q_DECL_IMPORT
#endif

#endif // PROJECTLINECOUNTER_GLOBAL_H
